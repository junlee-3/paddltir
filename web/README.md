...
Note: even in skip mode, `pnpm e2e` still boots and tears down a `next dev` server on port 3000 — Playwright starts its configured `webServer` before test filtering decides the single test should be skipped.
